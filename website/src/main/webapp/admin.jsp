				...
				<div class="card-body text-center">
					<div class="container">
						<img style="max-width: 125px;" class="img-fluid rounded-circle"
							src="images/user.png" alt="user_icon">
					</div>
					<h1>2342</h1>
		...
		<div class="col-md-4">
			<div class="card text-center">
				<div class="card-body">
					<div class="container">
						<img style="max-width: 125px;" class="img-fluid rounded-circle"
							src="images/category.png" alt="user_icon">
					</div>
					<h1>23432</h1>
		...
		<div class="col-md-4">
			<div class="card">
				<div class="card-body text-center">
					<div class="container">
						<img style="max-width: 125px;" class="img-fluid rounded-circle"
							src="images/product.png" alt="user_icon">
					</div>
					<h1>234</h1>
			...
			<div class="col-md-6">
				<div class="card" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 125px;" class="img-fluid rounded-circle"
								src="images/add_category.png" alt="user_icon">
						</div>
			...
			<div class="col-md-6">
				<div class="card" data-toggle="modal"
					...
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 125px;" class="img-fluid rounded-circle"
								src="images/add_product.png" alt="user_icon">
						</div>
